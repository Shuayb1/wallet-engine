...
func (s *Server) initializeRoutes() {
	...
	s.Router.HandleFunc("/activate_a_wallet/{id}", middlewares.SetMiddlewareJSON(s.ActivateAWallet)).Methods("PUT")
	s.Router.HandleFunc("/deactivate_a_wallet/{id}", middlewares.SetMiddlewareJSON(s.DeactivateAWallet)).Methods("PUT")
	...
	s.Router.HandleFunc("/credit_a_wallet/{id}", middlewares.SetMiddlewareJSON(s.CreditWallet)).Methods("POST")
	s.Router.HandleFunc("/debit_a_wallet/{id}", middlewares.SetMiddlewareJSON(s.DebitWallet)).Methods("POST")
